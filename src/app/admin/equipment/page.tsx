    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Equipment & Fleet Overview</h1>
            <p className="text-muted-foreground">Complete fleet and driver information</p>
          </div>
        </div>
      </div>
        ...
        <TabsContent value="fleet" className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredFleet.map((fleet) => (
              <Card key={fleet.fleetNumber} className="hover:shadow-md transition-shadow">
                <CardHeader>
                  <div className="flex items-center justify-between">
        ...
        <TabsContent value="trailers" className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredTrailers.map((trailer) => (
              <Card key={trailer.fleetNumber} className="hover:shadow-md transition-shadow">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-lg flex items-center gap-2">
        ...
        <TabsContent value="drivers" className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredDrivers.map((driver) => (
              <Card key={driver.name} className="hover:shadow-md transition-shadow">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-lg flex items-center gap-2">
