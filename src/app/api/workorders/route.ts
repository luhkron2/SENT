...
export async function GET(): Promise<NextResponse> {
  try {
    ...
    logger.error('Error fetching work orders:', error instanceof Error ? error : undefined);
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    logger.error('Error creating work order:', error instanceof Error ? error : undefined);
