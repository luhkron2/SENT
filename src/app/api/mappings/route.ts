...
export async function GET(): Promise<NextResponse> {
  try {
    ...
    logger.error('Error fetching mappings:', error instanceof Error ? error : undefined);
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    logger.error('Error saving mapping:', error instanceof Error ? error : undefined);
...
export async function DELETE(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    // Support both query params and request body for flexibility
    ...
    logger.error('Error deleting mapping:', error instanceof Error ? error : undefined);
    return NextResponse.json(
